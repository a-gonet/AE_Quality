...
ordered_logit_model <- polr(Quality.of.Life ~ ., data = df_for_modeling, Hess = TRUE, method = "logistic")
...
ordered_logit_model_update <- update(ordered_logit_model, . ~ . - Housing.Combined)
